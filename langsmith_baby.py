...
# os.environ["LANGCHAIN_API_KEY"] = "Enter key here or in .env"
# os.environ["LANGCHAIN_PROJECT"] = "Create project in langsmith dashboard to get this"
...
class DefaultResultsStorage:
    ...
    def add(self, task: Dict, result: str, result_id: str):
        ...
        if (
            ...
            self.collection.update(
                ...
                documents=result,
                metadatas={"tool": task["task_name"], "result": result},
            )
        else:
            self.collection.add(
                ids=result_id,
    ...
    def query(self, query: str, top_results_num: int) -> List[dict]:
        ...
        return [item["tool"] for item in results["metadatas"][0]]
